...
export default function About() {
  return (
    <div id="about" className="w-full h-full pt-20 pb-7 flex flex-col gap-10">
      <h2 className="text-center text-4xl font-bold text-[rgb(51,51,51)]">
        About Me
      </h2>
      <div className="flex flex-wrap-reverse md:flex-nowrap md:flex-row items-center justify-center gap-12">
        <span className="w-full lg:w-1/2 text-justify font-medium text-lg">
        ...
        <div className="w-full lg:w-1/2 h-[400px] bg-base-light-blue rounded-md p-10 shadow-lg">
